"""
Improved version of run.py that avoids hanging due to observability components.
This version sets environment variables to disable problematic components before importing any modules.
"""
import os
import sys
import site

# Set environment variables to disable problematic components BEFORE any imports
...
if __name__ == '__main__':
    ...
    print('Running backend server with DISABLED observability components...')
    # Use better exception handling for the import of api.endpoints
    try:
        print("Loading API endpoints...")
        # This is the import that was causing problems
        ...
        # If api.endpoints fails, fall back to a minimal API
        import uvicorn
