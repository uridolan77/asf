...
try:
    # Use mock imports to avoid hanging
    # We'll use the mock classes defined below instead of trying to import
    # from medical.ml.cl_peft
    print("Using mock CL-PEFT classes instead of importing from medical.ml.cl_peft")
    raise ImportError("Using mock classes instead")
