"""
Script to run the backend server with LLM Gateway enabled but observability disabled.
"""
import os
import sys
import uvicorn

# Set environment variables to disable observability components
...
# Enable LLM Gateway (by not setting DISABLE_LLM_GATEWAY)
...
if __name__ == "__main__":
    print("Running backend server with LLM Gateway enabled but observability disabled...")
    uvicorn.run(
        "api.endpoints:app", 
