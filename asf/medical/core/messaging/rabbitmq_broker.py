...
class MessageSerializer:
    ...
    This class provides methods for serializing and deserializing messages
    to and from bytes for transmission over the message broker.
    """
...
class RabbitMQBroker:
    ...
    and consuming messages from queues.
    """
