...
from ..dspy_signatures import MedicalSummarization
...
class MedicalSummarizationModule(MedicalDSPyModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize the medical summarization module.
        ...
        self.model = model or dspy.ChainOfThought(MedicalSummarization)
    ...
    def forward(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"Medical summarization failed: {str(e)}")
...
class StructuredMedicalSummarizationModule(MedicalDSPyModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize the structured medical summarization module.
        ...
        StructuredMedicalSummarizationSignature = dspy.Signature(
        ...
        # Create default model if not provided
        self.model = model or dspy.ChainOfThought(StructuredMedicalSummarizationSignature)
    ...
    def forward(
        ...
        **kwargs
        ...
        """
        Generate a structured summary of medical content.

        Args:
            text: Medical text to summarize
            content_type: Type of content (e.g., 'research_paper', 'clinical_note', 'guideline')
            audience: Target audience (e.g., 'clinician', 'researcher', 'patient')
            **kwargs: Additional arguments
        ...
        # Log audit
        self.log_audit(
            "STRUCTURED_MEDICAL_SUMMARIZATION_FORWARD",
        ...
        try:
            ...
            logger.error(f"Structured medical summarization failed: {str(e)}")
...
class MultiDocumentMedicalSummarizationModule(MedicalDSPyModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """
        Initialize the multi-document medical summarization module.
        ...
        self.single_doc_summarizer = single_doc_summarizer or MedicalSummarizationModule()
    ...
    def forward(
        ...
        **kwargs
        ...
        """
        Summarize multiple medical documents.

        Args:
            documents: List of medical documents to summarize
            audience: Target audience (e.g., 'clinician', 'researcher', 'patient')
            **kwargs: Additional arguments
        ...
        # Log audit
        self.log_audit(
            "MULTI_DOCUMENT_MEDICAL_SUMMARIZATION_FORWARD",
