...
IMPORT_REPLACEMENTS = {
    ...
    r"from asf\.medical\.ml\.services\.contradiction_service import UnifiedUnifiedContradictionService": "from asf.medical.ml.services.unified_contradiction_service import UnifiedUnifiedUnifiedContradictionService",
    r"from asf\.medical\.ml\.services\.enhanced_contradiction_service import EnhancedUnifiedUnifiedContradictionService": "from asf.medical.ml.services.unified_contradiction_service import UnifiedUnifiedUnifiedContradictionService",
...
CLASS_REPLACEMENTS = {
    ...
    r"UnifiedUnifiedContradictionService": "UnifiedUnifiedUnifiedContradictionService",
    r"EnhancedUnifiedUnifiedContradictionService": "UnifiedUnifiedUnifiedContradictionService",
}
