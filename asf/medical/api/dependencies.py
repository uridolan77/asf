...
from asf.medical.api.auth import get_current_user, oauth2_scheme
...
def get_contradiction_service() -> UnifiedContradictionService:
    ...
    Returns:
        UnifiedContradictionService: The contradiction service
    """
    return get_service(UnifiedContradictionService)()
